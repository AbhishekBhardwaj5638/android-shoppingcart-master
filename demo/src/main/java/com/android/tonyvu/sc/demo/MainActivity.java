...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView tvEmail=(TextView)findViewById(R.id.tvProductListHeader);


        final String email=getIntent().getStringExtra("email");
        final String guestEmail=getIntent().getStringExtra("guestMail");
        if(guestEmail.isEmpty()){
        tvEmail.setText("ProductList For "+email);}
        else{
            tvEmail.setText("Product For "+guestEmail);
        }
